    ...
    <div class="w-full  relative sm:flex-auto sm:mx-[19px]">
        ...
        <section class="px-5 py-3 w-full bg-[#13151b]">
            <div class="w-full flex items-center">
                ...
                <p class="px-2 text-[#d0d0d0]">为了您的账户资金安全，请您先验证您的提现密码</p>
            </div>
        ...
        <section v-if="userValue?.realname == ''"
        ...
        <section class="px-5 w-full  pt-3">
            <div class="py-3 my-3 px-5 flex items-center w-full relative bg-[#282b32]   ">
                ...
                <form @click.prevent class="w-full text-start text-[#7e7e7e]">
                    <div class="relative w-full    ">
                        <input v-model="withdrawpass" type="password" placeholder="请输入取款密码" autocomplete="off" maxlength="16" min="6" max="16"
        ...
        <section class="px-6 py-3 ">
            ...
            <div @click="BindWithPass" class="py-5 text-base w-full btn_login text-center">
                下一步
            </div>
        </section>
