    ...
    <div class="h-full w-[212px] min-w-[212px] flex flex-col relative">
        <div v-if="!token">
            <div @click="goReg()"
                ...
                <img src="@/assets/pc/Home/silver_logo.png" alt="" class="w-auto h-auto">
            </div>
            <div class="py-2">
                <div @click="goLogin()"
        ...
        <div v-else>
            <div class="bg-[#24252a] w-full h-[70px] __bginfo mb-2 px-2 py-1 cursor-pointer">
        ...
        <div class="bg-gradient-to-br from-[#212225]  to-[#04162f] text-sm  relative"
            :class="token ? 'h-[625px]' : 'h-[675px]'">
            <nav class="relative px-1">
                <div class="pt-[10px] ">
                    <ul class=" p-0 ">
                        <li class="mb-[20px] relative border-b border-solid border-[#696768] py-3">
                        ...
                        <li class="mb-[20px] relative border-b border-solid border-[#696768] pb-4">
                        ...
                        <li class="mb-[15px] relative pb-4 border-b border-solid border-[#696768]">
