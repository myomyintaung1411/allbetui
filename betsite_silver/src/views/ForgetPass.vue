            ...
            <form @click.prevent class="py-3">
                <div
                    ...
                    <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                        <input v-model="name" autocomplete="off" class=" input-name placeholder-[#d7d4d4] 
                ...
                <div
                    class="bg-[#13151b] my-5 formDiv border border-solid border-[#272c33] relative overflow-hidden flex items-center mx-auto px-2 h-16">
                    <div
                        class="relative flex items-center justify-center w-32 h-5   border-r border-[#d7d4d4] border-solid">
                        <img src="@/assets/mobile/user/phone.svg" class="w-5 h-5 ">
                    </div>
                    <div @click="showPhoneDialog = !showPhoneDialog"
                        class="w-[100px] text-sm whitespace-nowrap cursor-pointer text-white border-[#d7d4d4] mx-2   h-full text-center flex justify-center items-center">
                        <p>{{ selectPhone || '中国+86' }}</p>
                        <ChevronDownIcon class="w-5 h-5"></ChevronDownIcon>
                    </div>
                    <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                        <input v-model="phoneNum" autocomplete="off" class=" input-name placeholder-[#d7d4d4] 
                                border-none outline-none focus:outline-none focus:border-none    
                ...
                <div
                    ...
                    <div class=" w-full h-full  text-sm flex justify-center items-center relative">
                        <input v-model="pass" autocomplete="off" :type="passwordField" class=" input-name  focus:border-none border-none outline-none
                          focus:outline-none placeholder-[#d7d4d4] w-full pl-4 h-full " id="password" pattern=""
                ...
                <section class="pc-reg-container min-h-[450px] absolute bottom-[2rem] right-[9rem]">
                    ...
                    <form @click.prevent class="py-3 w-full">
                        ...
                        <div
                            ...
                            <div
                                class="relative flex items-center justify-center w-[120px] h-5   border-r border-[#d7d4d4] border-solid">
                                <img src="@/assets/mobile/user/phone.svg" class="w-5 h-5 ">
                            </div>
                            <div @click="showPhoneDialog = !showPhoneDialog"
                            ...
                            <div class=" border-none w-full h-[60px] text-sm flex justify-center items-center relative">
                                <input v-model="phoneNum" autocomplete="off" class=" input-name text-[#d0d0d0]   placeholder-[#d7d4d4] 
                                border-none outline-none focus:outline-none focus:border-none    
                        ...
                        <div
                            ...
                            <div class=" w-full h-full  text-sm flex justify-center items-center relative">
                                <input v-model="pass" autocomplete="off" :type="passwordField" class=" input-name  focus:border-none border-none outline-none
                          focus:outline-none placeholder-[#d7d4d4] w-full pl-4 h-full " pattern="" name="username"
