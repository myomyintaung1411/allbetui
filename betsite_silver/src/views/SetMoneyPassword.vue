            ...
            <form @click.prevent>
                <div class="pt-8 bg-[#13151b] text-base">
                    <div
                        ...
                        <div class="relative flex items-center h-full justify-start w-20">
                            <p>用户名</p>
                        </div>
                ...
                <div class="bg-[#13151b] text-base">
                    <div class=" formDiv   relative overflow-hidden flex items-center mx-2 px-2 h-20">
                        <div class="relative flex items-center h-full justify-start w-24">
                            <p>取款密码</p>
                        </div>
                        <div class="formInput w-full h-full text-base flex justify-center items-center relative">
                            <input v-model="moneyPass" autocomplete="off" :type="con_passField"
                                class=" input-name placeholder-[#d7d4d4]  focus:border-none border-none outline-none bg-transparent focus:outline-none w-full h-full"
                ...
                <div class="py-9 w-full px-10">
                    <button @click="setMoneyPass" class="w-full btn_login text-base py-3">
                        设置取款密码
                    </button>
                </div>
            </form>
                ...
                <form @click.prevent>
                    <div class="bg-[#13151b] my-5   formDiv relative overflow-hidden flex items-center mx-auto  h-14">
                        <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                            <input disabled type="tel" autocomplete="off" class=" input-name text-[#d7d4d4] placeholder-[#d7d4d4]  
                    ...
                    <div class="bg-[#13151b] my-5   formDiv relative overflow-hidden flex items-center mx-auto  h-14">
                        <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                            <input v-model="phonecode" autocomplete="off" class=" input-name text-[#d7d4d4] placeholder-[#d7d4d4]   
                             border-none outline-none focus:outline-none focus:border-none    
                    ...
                    <div @click="BindcheckCode" class="relative py-5 w-full cursor-pointer">
        ...
        <div v-if="changePhone" class="py-10 flex flex-col justify-center items-center">
            ...
            <div class="px-3 py-5 form w-[381px]">
                <form @click.prevent>
                    ...
                    <div @click="setMoneyPass" class="relative py-5 w-full cursor-pointer">
                        <img src="@/assets/pc/Home/bg.png" alt="" class="w-auto h-auto">
                        <div class="absolute bottom-0  w-full h-full flex justify-center items-center text-base text-black">设置取款密码</div>
                    </div>
                </form>
            </div>
        </div>
