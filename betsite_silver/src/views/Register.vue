                ...
                <div class="pc-reg-container min-h-[550px] absolute bottom-30 right-[7rem] pt-14">
                    <div class="flex flex-col items-center  h-full px-6 py-6">
                            ...
                            <form @click.prevent>
                                <div class="w-[377px] h-full flex flex-col items-stretch  mx-auto">
                                            ...
                                            <div class="h-full w-full relative overflow-hidden flex items-center mx-auto ">
                                                <div
                                                    ...
                                                    <input v-model="confirmpass" autocomplete="off" :type="con_passField"
                                                        class=" pc-input bg-transparent placeholder-[#d7d4d4] w-full h-full "
                                                        id="pcconfirmpass" pattern="" name="confirmpass"
                                                        placeholder="请输入确认密码" min="6" max="12" maxlength="12">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <input v-model="phoneNum" autocomplete="off" type="tel" class=" pc-input bg-transparent   
                                                        placeholder-[#d7d4d4] w-full h-full " id="pcphoneNum" pattern=""
                                                        name="phoneNum" placeholder="手机号码" min="11" max="11" maxlength="11">
                                            ...
                                            <div class="h-full w-full relative overflow-hidden flex items-center mx-auto ">
                                                <div
                                                    ...
                                                    <input v-model.trim="inviteCode" autocomplete="off" type="text"
                                                        class=" pc-input bg-transparent placeholder-[#d7d4d4] w-full h-full "
                                                        id="inviteCode" pattern="" name="inviteCode" placeholder="邀请码"
                                                         maxlength="17">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex justify-between mt-[30px] -mx-[11px]">
                                        ...
                                        <div @click="activeTab == 0 ? Register() : PhoneReg()"
                        ...
                        <div class=" text-[#747782] text-center">已有账户？点这里
                            <router-link to="/login" class="switcher transition-3s cursor-pointer text-[#d7d4d4]"> 登录
                            </router-link>
                        </div>
                    </div>
                </div>
        ...
        <div class="login px-5 w-full">
            ...
            <section class="py-8 px-8 w-full">
                <div class="flex items-center justify-evenly">
                    ...
                    <a @click="Tabclick(1)" class=" text-xl tracking-wide relative "
                        :class="activeTab == 1 ? 'font-medium before:absolute before:w-12 before:h-[1px]  before:bg-[#d7d4d4] before:bottom-0 before:-mb-1' : 'text-[#656569]'">手机注册</a>
                </div>
            </section>
            ...
            <form @click.prevent class="pt-3 focus:border-none">
                <div v-if="activeTab == 0"
                    ...
                    <div
                        class="relative flex items-center justify-center w-20 py-0 h-5 border-r border-[#d7d4d4] border-solid">
                ...
                <div v-if="activeTab == 0"
                    ...
                    <div class="formInput w-full h-full text-sm flex justify-center items-center relative">
                        ...
                        <XIcon v-if="confirmpass" @click="confirmpass = ''"
                            class="h-5 w-5 cursor-pointer  absolute right-10  "></XIcon>
                        <div class="absolute right-3">
                            <EyeIcon v-if="con_passField !== 'password'" @click="confirmshowVisibile" class="w-5 h-5 " />
                            <EyeOffIcon v-else @click="confirmshowVisibile" class="w-5 h-5 " />
                        </div>
                    </div>
                </div>
                ...
                <div v-if="activeTab == 1"
                    class="bg-[#13151b] border border-solid border-[#272c33] my-5 formDiv relative overflow-hidden flex items-center mx-auto px-2 h-16">
                    <div
                        class="relative flex items-center justify-center w-14 py-0 h-5     border-r border-[#d7d4d4] border-solid">
                        <UserIcon class="w-5 h-5 "></UserIcon>
                    </div>
                    <div class="formInput w-full h-full text-sm flex justify-center items-center relative">
                        <input v-model="name" autocomplete="off"
                ...
                <div v-if="activeTab == 1"
                    class="bg-[#13151b] border border-solid border-[#272c33] my-5 formDiv   relative overflow-hidden flex items-center mx-auto px-2 h-16">
                    <div
                        class="relative flex items-center justify-center w-[90px] h-5 border-r border-[#d7d4d4] border-solid">
                ...
                <div v-if="show_inviteCode_input"
                    class="bg-[#13151b] border border-solid border-[#272c33] my-5 formDiv  relative overflow-hidden flex items-center mx-auto px-2 h-16">
                    <div
                        class="relative flex items-center justify-center w-20 py-1 h-5 border-r border-[#d7d4d4] border-solid">
                ...
                <div class="flex pt-4 items-center w-full justify-between space-x-8">
                    <router-link to="/"
                        class="flex items-center justify-center w-[50%] h-[45px] border border-solid border-[#d7d4d4] text-[#d7d4d4] font-bold text-md cursor-pointer">
                        取消
                    </router-link>
                    <div @click="activeTab == 0 ? Register() : PhoneReg()"
                        class="btn_login flex cursor-pointer items-center justify-center text-red-50 text-center h-[45px] w-full">
                        注册
                    </div>
                </div>
            </form>
...
import { XIcon, UserIcon, LockClosedIcon,CodeIcon, EyeIcon, EyeOffIcon, ChevronDownIcon, ChatAltIcon } from "@heroicons/vue/outline";
