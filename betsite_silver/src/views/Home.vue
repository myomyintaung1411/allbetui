...
<template>
  <div class=" sm:hidden overflow-y-auto relative home_bg">
    ...
    <div class="pl-3 w-full flex items-center justify-between pt-1.5 pb-3 bg-[#051630]">
      <img src="@/assets/mobile/home/fire.png" alt="" class="w-[6rem] h-5">
      <img src="@/assets/mobile/home/fire1.png" alt="" class="w-[9rem] h-3">
    </div>

    <section class="pl-2 pb-2 w-full flex items-center justify-end bg-[#051630]">
    ...
    <section @click="goBrand()" class="w-full px-3 pt-1 pb-2 relative flex justify-between items-center bg-[#051630]">
