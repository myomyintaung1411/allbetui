    ...
    <div class="w-full h-screen bg-black relative sm:hidden sm:mx-[19px]">
        ...
        <div v-if="!changePhone" class="py-5 w-full">
            <form @click.prevent>
                    ...
                    <div
                        ...
                        <div class="formInput w-full h-full text-sm flex justify-center items-center relative">
                            <input disabled autocomplete="off" :type="passwordField"
                                ...
                                id="password" pattern="" name="username" :placeholder="hideMiddle(userValue?.phone, 2, 2)"
                                min="6" max="16" maxlength="16">
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-5 w-full px-10">
                    <button @click="BindcheckCode" class="w-full btn_login text-base py-3">
                        下一步
                    </button>
                    <div class="w-full py-6 flex items-center justify-center  space-x-2">
                        <img src="@/assets/mobile/home/service.png" alt="" class="w-8 h-6">
                        <p class="text-[#9b9b9b]">手机号码不正确？</p>
                        <p @click="goService" class="z-10 ">联系客服</p>
                    </div>
                </div>
            </form>
        </div>
            ...
            <form @click.prevent>
                <div class="bg-[#13151b] text-base relative">
                    <div
                        ...
                        <div class="relative whitespace-nowrap flex items-center h-full justify-center w-40">
                            <p>请输入新手机</p>
                        </div>
                        ...
                        <div class="formInput w-full h-full text-sm flex justify-center items-center relative">
                            <input v-model="newphone" autocomplete="off" type="text"
                                class=" input-name placeholder-[#d7d4d4]  focus:border-none border-none outline-none bg-transparent focus:outline-none w-full h-full"
                ...
                <div class="py-7 w-full px-10">
                    <button @click="changePhoneNum" class="w-full btn_login text-base py-3">
                        修改手机号
                    </button>
                    <div class="w-full py-6 flex items-center justify-center space-x-2">
                        <img src="@/assets/mobile/home/service.png" alt="" class="w-8 h-6">
                        <p>手机号码不正确？</p>
                        <p class="text-[#9b9b9b] ">联系客服</p>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="hidden sm:block relative w-full bg-[#1f2129] my-2 py-[20px] px-[18px]">
                ...
                <form @click.prevent>
                    <div class="bg-[#13151b] my-5   formDiv relative overflow-hidden flex items-center mx-auto  h-14">
                        <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                            <input disabled type="tel" autocomplete="off"
                                class=" input-name placeholder-[#d7d4d4] border-none outline-none focus:outline-none focus:border-none w-full h-full"
                                pattern="" name="code" :placeholder="hideMiddle(userValue?.phone, 2, 2)" maxlength="11"
                                min="11" max="11">
                        </div>
                    </div>
                    <div class="bg-[#13151b] my-5   formDiv relative overflow-hidden flex items-center mx-auto  h-14">
                    ...
                    <div @click="BindcheckCode" class="relative cursor-pointer">
        ...
        <div v-if="changePhone" class="py-5 flex flex-col justify-center items-center">
            <div class="mb-[40px] flex space-x-3 items-center justify-center">
                ...
                <span class="text-base">更改手机号</span>
            </div>
            <section class="form w-[381px]">
                <form @click.prevent>
                    <div class="bg-[#13151b] my-5   formDiv relative  flex items-center mx-auto  h-14">
                        <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                            ...
                            <input v-model="newphone" type="tel" autocomplete="off" class=" input-name placeholder-[#d7d4d4] text-[#d7d4d4] 
                                       border-none outline-none focus:outline-none focus:border-none    
                                     w-full h-full" pattern="" name="code" placeholder="电话号码" maxlength="11" min="11"
                                max="11">
                        </div>
                    ...
                    <div class="bg-[#13151b] my-5   formDiv relative overflow-hidden flex items-center mx-auto  h-14">
                        <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                            <input v-model="phonecode" autocomplete="off" class=" input-name placeholder-[#d7d4d4] text-[#d7d4d4] 
                                     border-none outline-none focus:outline-none focus:border-none    
                                     w-full h-full" placeholder="6位短信校验码" type="text" maxlength="6" min="6" max="6">
                            <XIcon v-if="phonecode" @click="phonecode = ''"
                                class="h-5 w-5 cursor-pointer text-[#d7d4d4] absolute right-28  ">
                            </XIcon>
                            <button :disabled="codeDisable" :class="!codeDisable ? ' ' : ' opacity-80 cursor-not-allowed'"
                                @click="getCode()"
                    ...
                    <div @click="changePhoneNum" class="relative cursor-pointer">
                        <img src="@/assets/pc/Home/bg.png" alt="" class="w-auto h-auto">
                        <div class="absolute bottom-0  w-full h-full flex justify-center items-center text-base text-black">
                            修改手机号</div>
                    </div>
