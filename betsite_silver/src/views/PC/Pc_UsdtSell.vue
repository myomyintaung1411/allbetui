<template>
    <div class="hidden sm:block relative flex-auto mx-[19px] bg-[#1f2129] text-[#d7d4d4]">
        <div class="main">
            <div class="main-content w-full relative">
                <div class="w-full tabs   border-b border-gray-800">
                    <div class="text-base text-center py-5 cursor-pointer w-[125px] tracking-wider border-b border-[#d7d4d4]">
                        USDT兑人民币
                    </div>
                </div>
                <section class="relative w-full bg-[#1f2129] my-2 py-[20px] px-[18px]">
                  <div class="px-5 py-3">请选择下列交易所</div>
        ...
        <div class="w-[500px] py-10 px-3 text-[#d7d4d4]">
            <p class="text-center text-xl">温馨提示</p>
            <div class="w-full text-start py-7 px-8">
                <p class="text-sm">为方便游戏，建议您持有少量USDT。使用USDT存款秒到账，资金更安全，是在线博彩用户的最佳选择。</p>
            </div>

            <div class="flex pt-5 items-center w-full justify-evenly px-3">
                <div @click="Dialog = false" 
                    class="flex items-center justify-center h-[50px]  border border-solid border-[#d7d4d4] cursor-pointer px-10  whitespace-nowrap">
                    继续卖出
                </div>
                <router-link to="/">
                    <div class="relative cursor-pointer">
                        <img src="@/assets/pc/Home/bg.png" alt="" class="w-[140px] h-[50px]">
                        <div class="absolute bottom-0 w-full h-full flex justify-center items-center text-base text-black">先不卖了</div>
                    </div>
                </router-link>
