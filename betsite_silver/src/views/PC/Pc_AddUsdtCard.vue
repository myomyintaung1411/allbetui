        ...
        <div class="main">
            <div class="main-content w-full relative">
                <div class="w-full tabs  border-b border-[#d7d4d4]">
                    <div class="text-base text-center pt-5 pb-1 cursor-pointer w-[180px] tracking-wider border-b-[3px] border-[#d7d4d4]">
                        添加USDT地址
                    </div>
                </div>
                <!-- first step -->
                <section v-if="!verify" class="relative w-full my-2 py-[20px] px-[18px] bg-[#14151a] text-[#d7d4d4]">
                ...
                <section v-if="moneyAddData?.length > 0 && verify"
                    class=" w-full mt-[12px] py-[20px] px-[18px] relative bg-[#1f2129] text-[#d7d4d4]">
