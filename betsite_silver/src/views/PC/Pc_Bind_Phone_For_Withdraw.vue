<template>
    <div class="hidden sm:block relative flex-auto mx-[19px]  bg-[#1f2129]">
        <div class="main">
            <div class="main-content w-full relative">
                <div class="w-full tabs border-b border-[#d7d4d4] bg-black">
                    <div
                        class="text-base text-center py-4 cursor-pointer w-[140px] tracking-wider border-b-[4px] border-[#d7d4d4]">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <input v-model="phonecode" autocomplete="off" 
                                        ...
                                        id="phonecode" pattern="" name="phonecode" placeholder="6位短信校验码" type="text" maxlength="6" min="6"
                                        max="6">
    ...
    <NotCloseDialog :show="depo_Dialog" @close="depo_Dialog = false">
        <div class="w-[500px] min-w-[300px] py-10 px-3">
            ...
            <div class="flex pt-5 items-center w-full  justify-evenly px-3">
                <router-link to="/" 
                    class="btn flex items-center justify-center  btn-outline  h-[50px]  border border-solid border-[#d7d4d4] cursor-pointer px-16  whitespace-nowrap">
                    取消
                </router-link>
                <div @click="requestName" class="btn flex cursor-pointer px-16 whitespace-nowrap items-center justify-center text-[#272c33] text-center btn-primary h-[50px]">
                    确认
                </div>
            </div>
        </div>
