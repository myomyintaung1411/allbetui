<template>
    <section class="w-full h-auto flex-auto relative mx-[19px] text-[#d7d4d4]">
                ...
                <div class="pay_mentsection mx-0 relative h-full flex flex-col">
                    ...
                    <div class="py-[20px] px-[13px]">
                        <div @click="clickBank(0)" 
                            class="h-[50px] w-full px-3 relative cursor-pointer border border-solid flex justify-between items-center mb-[10px] border-[#d7d4d4] rounded-md">
                            ...
                            <div class="form_input relative">
                                <div class="bg-[#13151b]  formDiv relative overflow-hidden flex items-center mx-auto px-2 h-14">
                                    <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                                        ...
                                        class=" input-name placeholder-[#d7d4d4] text-[#d7d4d4] border-none outline-none focus:outline-none focus:border-none w-full h-full"    
                                ...
                                <div
                                    ...
                                    <div
                                        class="relative flex items-center justify-center w-20 py-1 border-r border-text-[#d7d4d4] border-solid">
                                    ...
                                    <div
                                        ...
                                        <input v-model="amount" autocomplete="off" class=" input-name text-[#d7d4d4] placeholder-[#d7d4d4] 
                                ...
                                <div class="money_sec mx-auto my-[20px]">
                                    <div class="w-full p-0 m-0 flex flex-wrap">
                                        ...
                                        class="relative w-[117px] h-[44px] text-center leading-[44px]  text-[17px] mt-[10px] mr-[10px] border border-solid border-[#d7d4d4] cursor-pointer"
