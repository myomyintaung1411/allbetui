<template>
    <div class="w-full h-screen relative bg-[#051630]">
        ...
        <section class="w-full px-5 pt-8 pb-3">
            <div class="flex items-center  w-full mx-4 space-x-2">
                <div @click="clickCard(0)" class=" py-1 px-1 whitespace-nowrap flex items-center space-x-2  w-[45%] 
                        border border-solid" :class="activeCard == 0 ? ' border-[#d0d0d0]' : ' border-[#2f343c]'">
                ...
                <div @click="clickCard(1)" class=" py-1 px-1 whitespace-nowrap flex items-center space-x-2  w-[45%] 
                        border border-solid" :class="activeCard == 1 ? ' border-[#d0d0d0]' : ' border-[#2f343c]'">
        ...
        <div @click="gonext()" class="relative cursor-pointer mx-6">
        ...
        <div class="absolute bottom-0  __bgdcbox"></div>
    </div>
</template>
