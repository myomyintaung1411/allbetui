        ...
        <section class="py-4 px-8 w-full">
            <div class="flex items-center justify-evenly">
                <a @click="Tabclick(0)" class=" text-xl tracking-wide relative 
                                        ...
                                        "
                    :class="Tab == 0 ? 'text-[#a6a6a6] font-medium before:absolute before:w-12 before:h-[2px] before:left-0 before:bg-[#eed0a4] before:bottom-0 before:-mb-1' : 'text-[#656569]'">结算洗码</a>
                <a @click="Tabclick(1)" class=" text-xl tracking-wide relative "
                    :class="Tab == 1 ? 'text-[#a6a6a6] font-medium before:absolute before:w-12 before:h-[2px] before:left-0 before:bg-[#eed0a4] before:bottom-0 before:-mb-1' : 'text-[#656569]'">领取反水费</a>
            </div>
        </section>
