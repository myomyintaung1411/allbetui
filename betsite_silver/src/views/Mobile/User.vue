...
<template>
    <div class="sm:hidden relative  h-full overflow-y-auto w-full  text-[#d7d4d4] bg-[#051630]">
        ...
        <section class="px-3 w-full relative">
            <div class="user_bg bg-gradient-to-r from-[#1d1b1c] to-[#350d49] relative flex flex-col py-1  px-3">
                ...
                <div class="bg-[#d7d4d4] h-[1px] w-[150px] mt-2"></div>
            </div>
        </section>
    ...
    <NotCloseDialog :show="logoutDialog" @close="logoutDialog = false">
        <div class="w-[90vw] py-10 text-[#d7d4d4] px-3">
            ...
            <div class="flex pt-5 items-center w-full  justify-evenly px-3">
                <router-link to="/" class="flex items-center justify-center h-[50px] border border-solidborder-[#d7d4d4] text-[#d7d4d4] font-bold text-md cursor-pointer px-12">
                    取消
                </router-link>
