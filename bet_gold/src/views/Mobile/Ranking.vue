<template>
  <div class="w-full h-auto relative">
    ...
    <section class="w-full px-3 py-2 relative">
    ...
    <section class="px-3 py-2 w-full relative">
      <div class="flex flex-col">
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            <div class="overflow-hidden">
              <table class="min-w-full relative">
                <thead class="bg-[#1e2129] sticky top-0">
                  <tr>
                ...
                <tbody>
                  <tr v-for="data in ranking " :key="data.id" class=""
                    :class="data.id % 2 != 0 ? 'bg-[#272c33]' : 'bg-[#1e2129]'">
                    <td class="px-6 py-4 font-bold flex items-center whitespace-nowrap text-center text-sm">
                      ...
                      <span>
                        ...
                        <img src="@/assets/pc/home/arrowDown.png" alt="" class="w-3 h-3 mx-1 rotate-180">
                      </span>
                    </td>
