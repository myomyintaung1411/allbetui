<template>
            ...
            <div class="flex flex-wrap justify-between space-y-3 ">
                <div class="w-full flex justify-between">
                    <div @click="chooseBank(0)" class=" w-[47%] border border-solid py-1.5  px-2 rounded-md"
                        :class="activeBank == 0 ? 'border-[#dfa009]' : 'border-[#343941]'">
                    ...
                    <div @click="chooseBank(1)" class="w-[47%] border border-solid py-1.5 px-2 rounded-md"
                        :class="activeBank == 1 ? 'border-[#dfa009]' : 'border-[#343941]'">
                ...
                <div @click="chooseBank(2)" class="w-[47%] border border-solid py-1.5 px-2 rounded-md"
                    :class="activeBank == 2 ? 'border-[#dfa009]' : 'border-[#343941]'">
                ...
                <div @click="chooseBank(3)" class="w-[47%] border border-solid py-1.5 px-2 rounded-md"
                    :class="activeBank == 3 ? 'border-[#dfa009]' : 'border-[#343941]'">
                ...
                <div @click="chooseBank(4)" class="w-[47%] border border-solid py-1.5 px-2 rounded-md"
                    :class="activeBank == 4 ? 'border-[#dfa009]' : 'border-[#343941]'">
        ...
        <section class="px-5 py-3 w-full ">
            <form @click.prevent class="relative">
                <input disabled type="text" :placeholder="hideWord(userValue?.realname)"
                    class="w-full input_foucs placeholder-[#dfa009]  h-12 bg-transparent border border-solid border-[gray] pr-12">
                <XIcon v-if="name" @click="name = ''"
                    class="h-5 w-5 cursor-pointer top-3 absolute right-6 text-[#dfa009]"></XIcon>
            </form>
                ...
                <form @click.prevent>
                    <div class="relative">
                        <input v-model="amount" type="number" min="1" max="100000000" @input="eventName"
                            ...
                            class="w-full input_foucs placeholder-[#dfa009] left-11  h-12 bg-transparent border border-solid border-[gray]">
    ...
    <NotCloseDialog :show="depo_Dialog" @close="depo_Dialog = false">
        <div class="w-[90vw] py-10 text-[#dfa009] px-3 text-sm ">
            ...
            <div class="w-full h-12 bg-[#13151b] my-5">
                <form @click.prevent>
                    <input v-model="realname" type="text" placeholder="真实姓名" name="username" id="usr" class="w-full focus:border-none  focus:outline-0 focus:shadow-none placeholder-[#dfa009]
            ...
            <div class="flex pt-5 items-center w-full  justify-evenly px-3">
                <router-link to="/"
                    class="flex items-center justify-center h-[50px] border border-solid border-[#dfa009] cursor-pointer px-12 whitespace-nowrap">
                    取消
                </router-link>
