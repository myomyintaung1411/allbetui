  ...
  <div class="w-full h-auto  bg-[#171a21] relative">
    ...
    <div class="flex justify-between px-10 py-2 w-full">
      <div @click="Tabclick(0)" class=" tracking-wide py-1 "
        :class="activeTab == 0 ? 'text-[#aaa9a9] border-b-[3px] py-1 border-[#dfa009]' : 'text-white'">取款</div>
      <div @click="Tabclick(1)" class=" tracking-wide  py-1 "
        :class="activeTab == 1 ? 'text-[#aaa9a9] border-b-[3px] py-1 border-[#dfa009]' : 'text-white'">存款</div>
      <div @click="Tabclick(2)" class=" tracking-wide  py-1 "
        :class="activeTab == 2 ? 'text-[#aaa9a9] border-b-[3px] py-1 border-[#dfa009]' : 'text-white'">洗码</div>
      <div @click="Tabclick(3)" class=" tracking-wide  py-1 "
        :class="activeTab == 3 ? 'text-[#aaa9a9] border-b-[3px]  border-[#dfa009]' : 'text-white'">优惠</div>
    </div>
    ...
    <section class="py-4 w-full flex justify-between items-center px-5">
      ...
      <div @click="request()" class="px-2 py-1 border border-[#dfa009] text-[#fff]">刷新记录</div>
    </section>
