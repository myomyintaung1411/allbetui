<template>
    <div class="hidden sm:block relative flex-auto mx-[19px] py-2 bg-[#1f2129] ">
        <div class="main">
            <div class="main-content w-full relative">
                <div class="w-full tabs   border-b border-gray-800">
                    <div
                        class="text-base text-center py-1 cursor-pointer w-[140px] tracking-wider border-b border-[#d7d4d4]">
                        取款
                    </div>
                </div>
                <section v-if="!verifyWith" class="relative w-full my-2 py-[20px] px-[18px]">
                            ...
                            <section class="form w-[381px] relative">
                                <div
                                    ...
                                    <div
                                        ...
                                        <input disabled autocomplete="off" class=" input-name placeholder-[#d7d4d4]   
                                ...
                                <div class="flex justify-end w-full items-center text-[#858585]  text-sm">
                                    ...
                                    请点
                                    <span class="text-[#d7d4d4]">复制</span>
                                    <span>后粘贴</span>
                                </div>
                                <div
                                    class="bg-[#13151b] my-2   formDiv relative overflow-hidden flex items-center mx-auto  h-14">
                                    <div class=" border-none w-full px-3 h-full text-sm flex  items-center relative">
                                        ...
                                        <div class="h-5 ml-4 px-6 text-base tracking-widest">
                                            {{ userValue?.balance }} ¥
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <input v-model="amount" autocomplete="off" class=" input-name placeholder-[#d7d4d4] border-none outline-none focus:outline-none focus:border-none    
                                            w-full h-full" id="amount" pattern="" name="amount" placeholder="请输入取款余额"
                                            type="number" min="1" max="100000000" @input="eventName">
                                ...
                                <div
                                    ...
                                    <div
                                        class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                                        <input v-model="realname" autocomplete="off"
                                            class=" input-name placeholder-[#d7d4d4] border-none outline-none focus:outline-none focus:border-none pr-10 w-full h-full"
                                            id="realname" pattern="" name="realname" placeholder="持卡人" type="text">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <input v-model="cardnumber" autocomplete="off"
                                            class=" input-name placeholder-[#d7d4d4] border-none outline-none focus:outline-none focus:border-none pr-10  w-full h-full"
                                            id="cardnumber" pattern="" name="cardnumber" placeholder="卡号" type="text">
                                ...
                                <div
                                    ...
                                    <div
                                        class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                                        <input v-model="bankacc" autocomplete="off"
                                            class=" input-name placeholder-[#d7d4d4] pr-10 border-none outline-none focus:outline-none focus:border-none w-full h-full"
                                            id="bankacc" pattern="" name="bankacc" placeholder="开户行" type="text">
                                ...
                                <div v-if="bank_list_dialog" class=" w-full overflow-y-hidden  ">
                                    <div
                                        ...
                                        <div v-for="(bank) in moneyAddData" :key="bank.id" @click="chooseBank(bank)"
                                            class="flex border-b border-[#202330] items-center text-center text-[18px] placeholder-[#d7d4d4] center z-20 py-4 bg-[#272c33] px-3 w-full">
                                        ...
                                        <div @click="bank_list_dialog = false"
                                            class="flex cursor-pointer py-3 text-base w-full btn_login text-center">
                                            取消
                                        </div>
                                    </div>
                                </div>
