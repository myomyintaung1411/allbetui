        ...
        <div class="main">
            <div class="main-content w-full relative">
                <div class="w-full tabs border-b border-[#d7d4d4] bg-black">
                    <div
                        class="text-base text-center py-3 cursor-pointer w-[140px] tracking-wider border-b-[1px] border-[#eed0a4]">
                        人民币取款
                    </div>
                </div>
                <section class="relative w-full bg-[#1f2129]  my-2 py-[20px] px-[18px]">
                    ...
                    <div class="py-5 flex flex-col justify-center items-center">
                        <div class="mb-[40px] flex space-x-3 items-center justify-center">
                            ...
                            <span class="text-base">为了您的账户资金安全，请您先验证您的提现密码</span>
                        </div>
                        ...
                        <section class="form w-[381px]">
                            ...
                            <div
                                ...
                                <div
                                    class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                                    <input v-model="withdrawpass" autocomplete="off" 
                                        class=" input-name placeholder-[#d7d4d4] border-none outline-none focus:outline-none focus:border-none w-full h-full"
                                        id="withdrawpass" pattern="" name="withdrawpass" placeholder="请输入取款密码" type="password" maxlength="17" min="6"
                                        max="6">
...
<script setup>
import { XIcon,  LockClosedIcon} from "@heroicons/vue/outline";
