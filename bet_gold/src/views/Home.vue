...
<template>
  <div class=" sm:hidden overflow-y-auto relative home_bg">
    <div class="w-full px-3">
      <div class="w-full flex justify-between items-center space-x-4 p-1 bg-gradient-to-tr from-[#1a0c1b] via-[#1a0c1b] to-[#766c76] header_bg">
        <div class="flex  items-center space-x-2">
            <img src="@/assets/pc/Home/logo.png" alt="" class="w-auto h-11 object-cover">
            <div class="flex-col items-center">
              <div class="flex items-center">
                <img src="@/assets/pc/Home/logoTitle1.png" alt="" class="w-auto h-4 object-cover">
                <img src="@/assets/pc/Home/logoTitle2.png" alt="" class="w-auto h-4 object-cover">
              </div>
                <img src="@/assets/pc/Home/logoword.png" alt="" class="w-auto h-[9px] object-cover">
            </div>
        </div>
        <div class="w-[30%]  ">
    ...
    <div v-if="!token" class="px-3 py-2 w-full flex items-center justify-between">
      ...
      <div class="w-[49%] h-[65px] relative bg-gradient-to-tl from-[#1a0c1b] via-[#1a0c1b] to-[#766c76]"
        ...
        <div class="flex flex-col justify-center items-center pt-2">
          <img src="@/assets/mobile/home/gglogo.png" alt="" class="w-[6rem] h-6">
          <img src="@/assets/mobile/home/gold_reg.png" alt="" class="w-auto h-auto">
        </div>
    ...
    <router-link to="/ranking">
      <img src="@/assets/mobile/home/1111.png" alt="" class="w-auto h-auto px-3 mt-2">
    </router-link>
    ...
    <section @click="goBrand()" class="w-full px-3 pt-1 pb-2 relative flex justify-between items-center bg-[#14171e]">
      ...
      <img src="@/assets/mobile/home/2222.png" alt="" class="w-full h-[30px]">
    </section>
      ...
      <div class="main-content w-full">
        ...
        <section class="flex justify-between items-center mt-4">
          <div @click="goGame(100)" class="relative cursor-pointer">
            <div class=" overflow-hidden  h-[178px] pb-[3px] w-[470px] relative">
          ...
          <div @click="goGame(100)" class="relative cursor-pointer">
            <div class=" relative overflow-hidden h-[178px]  w-[470px]">
        ...
        <section class="flex justify-between  items-center mt-4">
          <div @click="goGame(100)" class="relative cursor-pointer">
            <div class="  rounded h-[178px] w-[470px] relative">
          ...
          <div @click="goGame(103)" class="relative cursor-pointer">
            <div class=" relative overflow-hidden pt-[11px] h-[178px] w-[470px]">
        ...
        <section class="flex justify-between items-center mt-4">
          <div @click="goGame(104)" class="relative cursor-pointer">
            <div class=" relative overflow-hidden  h-[178px] w-[470px] pb-[2px]">
          ...
          <div class="relative">
            <div @click="goGame(106)" class=" cursor-pointer relative overflow-hidden   h-[178px] w-[470px]">
