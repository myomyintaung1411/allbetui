...
<template>
            ...
            <form @click.prevent class="py-3">
                <div
                    ...
                    <div class=" border-none w-full h-full text-sm flex justify-center items-center relative">
                        <input v-model="name" autocomplete="off" class=" input-name placeholder-[#dfa009] 
                ...
                <div
                    class="bg-[#13151b] my-5 formDiv border border-solid border-[#272c33] relative overflow-hidden flex items-center mx-auto px-2 h-16">
                    <div
                        class="relative flex items-center justify-center w-32 h-5   border-r border-[#dfa009] border-solid">
                        <img src="@/assets/mobile/user/phone.svg" class="w-5 h-5 ">
                    </div>
                    <div @click="showPhoneDialog = !showPhoneDialog"
                        class="w-[100px] text-sm whitespace-nowrap cursor-pointer text-white border-[#dfa009] mx-2   h-full text-center flex justify-center items-center">
                ...
                <div
                    ...
                    <div class=" w-full h-full  text-sm flex justify-center items-center relative">
                        <input v-model="pass" autocomplete="off" :type="passwordField" class=" input-name  focus:border-none border-none outline-none
                          focus:outline-none placeholder-[#dfa009] w-full pl-4 h-full " id="password" pattern=""
                ...
                <div class="py-7 w-full">
                    <button @click="ChangePass()" class="w-full btn_login text-base py-3 text-[#373c33] text-[19px]">
                        更改密码
                    </button>
                </div>
            </form>
    ...
    <div class="h-screen w-full relative hidden sm:block">
        ...
        <div class="register-fame">
            <div class="relative w-[900px] pt-20 mx-auto flex justify-between">
                <div class="h-[600px] w-auto">
                    <img src="@/assets/mobile/home/register2.png" alt="" class="w-full h-full">
                </div>
                <section class="pc-reg-container min-h-[450px] absolute bottom-[2rem] right-[9rem]">
                    ...
                    <form @click.prevent class="py-3 w-full">
                        ...
                        <div
                            ...
                            <div
                                class="relative flex items-center justify-center w-[120px] h-5   border-r border-[#dfa009] border-solid">
                                <img src="@/assets/mobile/user/phone.svg" class="w-5 h-5 ">
                            </div>
                            <div @click="showPhoneDialog = !showPhoneDialog"
                            ...
                            <div class=" border-none w-full h-[60px] text-sm flex justify-center items-center relative">
                                <input v-model="phoneNum" autocomplete="off" class=" input-name text-[#d0d0d0]   placeholder-[#dfa009] 
                                border-none outline-none focus:outline-none focus:border-none    
                        ...
                        <div
                            ...
                            <div class=" w-full h-full  text-sm flex justify-center items-center relative">
                                <input v-model="pass" autocomplete="off" :type="passwordField" class=" input-name  focus:border-none border-none outline-none
                          focus:outline-none placeholder-[#dfa009] w-full pl-4 h-full " pattern="" name="username"
                        ...
                        <div class="py-7 w-full">
                            ...
                            <div class="flex justify-between  -mx-[11px] mb-0">
                                <div @click="goUser()" class="btn flex items-center justify-center w-full btn-outline mx-[11px] h-[50px] border border-solid
                    border-[#dfa009] cursor-pointer
                    ">
                                    取消
                                </div>
